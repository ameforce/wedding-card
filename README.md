...
신랑·신부 이름, 예식 일시, 예식장명과 8층 안내, 주소, 교통·주차 안내, 지도 링크, 초대·스토리 문구, RSVP 미사용, OG 공유 미리보기와 대표 URL `https://wdcard.enmsoftware.com/`은 모두 사용자 확인값을 사용합니다. `weddingContent.unconfirmedContent`는 비어 있으며 기본 `npm run build`가 production 결과를 만듭니다.
