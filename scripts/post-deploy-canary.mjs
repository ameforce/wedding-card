...
export async function verifyGuestbookDeleteUi(baseUrl, identity, { chromiumImpl = chromium } = {}) {
  ...
  try {
    await page.goto(baseUrl.href, { waitUntil: "networkidle", timeout: HTTP_TIMEOUT_MS });
