// Keep the accepted knot and wings at their authored size. Only the outer
// strips are extended; the envelope window clips the result at its folds.
export const RIBBON_EDGE_RATIO = 0.05;
export const RIBBON_EDGE_SCALE = 2.5;
